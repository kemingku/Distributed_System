...
//    public class NewExecutor implements Runnable{
//        private Socket s;
//        //private String message;
//        //private BufferedReader breader;
////        private BufferedWriter bwriter;
//
//        public NewExecutor(Socket s) throws IOException {
//            this.s = s;
//            //breader = new BufferedReader(new InputStreamReader(s.getInputStream()));
////            message = this.s.getInetAddress() + "";
//            //sendMessageToClient();
//        }
//
//        @Override
